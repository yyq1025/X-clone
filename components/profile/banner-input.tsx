...
interface BannerInputProps {
  initialImg: string;
  onChange: (event: Blob | null) => void;
}

const BannerInput: FC<BannerInputProps> = ({ initialImg, onChange }) => {
      ...
      <div className="absolute inset-0 flex h-full w-full items-center justify-center bg-black/30">
        ...
        {!!imgSrc && (
          <Button
            ...
            className="ml-5 bg-gray-900/75 text-white/75 hover:bg-gray-800/75 hover:text-white/75"
          >
